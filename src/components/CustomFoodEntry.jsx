...
export default function CustomFoodEntry({ onAddFood, onCancel, saveToList = true }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
      <div className="bg-gray-800 rounded-3xl shadow-2xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto border border-gray-700 animate-scale-in">
        ...
        <p className="text-xs text-gray-500 mt-5 text-center bg-gray-700 rounded-xl p-3">
          * Required fields
        </p>
      </div>
    </div>
